    ...
    <>
      ...
      <section id="hero">
        <div className="container content">
          ...
          <h1>
            ...
            <span style={{ color: 'var(--primary-color)' }}>para um planeta</span> mais verde
          </h1>
          <p>
            A EcoTech desenvolve tecnologias inovadoras que conectam pessoas à natureza, reduzindo o
            impacto ambiental e promovendo um futuro mais sustentável para todos.
          </p>
      ...
      <section className="container" id="solution">
        <header>
          ...
          <p>
            Na EcoTech, acreditamos que tecnologia e sustentabilidade andam juntas. Nossas soluções
            são projetadas para gerar impacto positivo no meio ambiente e nos negócios dos nossos
            clientes.
          </p>
        </header>
      ...
      <section id="testimonials">
        <header>
          ...
          <p>
            Conheça as histórias de empresas e pessoas que já estão fazendo a diferença com as
            soluções sustentáveis da EcoTech.
          </p>
        </header>
      ...
      <section id="contact">
        <div className="container">
          <header>
            ...
            <p>
              Quer saber como podemos ajudar sua empresa a ser mais sustentável? Preencha o
              formulário abaixo e nossa equipe especializada entrará em contato.
            </p>
          </header>

          <ContactForm onSendEmail={handleSendEmail} />
        </div>
      </section>
